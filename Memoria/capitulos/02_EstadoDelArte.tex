...
\begin{figure}[H]
    \centering
    \subfloat[\centering Ejercicio de Sonid]{\includegraphics[width=0.35\textwidth]{imagenes/c2/sonid.jpeg}}
    % \caption{Vista de la lista de lecciones de la aplicación Sonid}
    \hspace{3em}
    \subfloat[\centering Menú de lecciones de Sonid]{\includegraphics[width=0.35\textwidth]{imagenes/c2/sonid1.jpeg}}
\end{figure}
