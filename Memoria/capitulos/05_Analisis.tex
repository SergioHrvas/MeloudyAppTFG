...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
            ...
            \textbf{PH}                  & 0.5                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá registrarse en el sistema rellenando un formulario con campos \\ como el nombre de usuario, el correo electrónico, la contraseña... \end{tabular}}  \\ \hline
            \textbf{Prioridad}           & Media                                        & \textbf{Dependencias} & \begin{tabular}[c]{@{}l@{}} --- \end{tabular}                      & \cellcolor[HTML]{D8D8D8}\begin{tabular}[c]{@{}l@{}}\textbf{Requisitos Funcionales}\end{tabular} & \begin{tabular}[c]{@{}l@{}}RF 1\end{tabular} \\ \hline
            \multicolumn{3}{|l|}{\cellcolor[HTML]{D8D8D8}\textbf{Pruebas de aceptacion}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}1. Todos los campos rellenados por el usuario serán almacenados en la base de datos \\ 2. La contraseña se almacenará cifrada para no comprometer la seguridad del usuario \end{tabular}}                                               \\ \hline
        \end{tabular}%
    }
\end{table}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
            ...
            \textbf{PH}                  & 0.25                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá registrarse en el sistema rellenando un formulario con campos \\ como el nombre de usuario, el correo electrónico, la contraseña... \end{tabular}}  \\ \hline
            \textbf{Prioridad}           & Media                                        & \textbf{Dependencias} & \begin{tabular}[c]{@{}l@{}} --- \end{tabular}                      & \cellcolor[HTML]{D8D8D8}\begin{tabular}[c]{@{}l@{}}\textbf{Requisitos Funcionales}\end{tabular} & \begin{tabular}[c]{@{}l@{}}RF 1\end{tabular} \\ \hline
            \multicolumn{3}{|l|}{\cellcolor[HTML]{D8D8D8}\textbf{Pruebas de aceptacion}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}1. Todos los campos rellenados por el usuario serán almacenados en la \\ base de datos \\ 2. La contraseña se almacenará cifrada para no comprometer la seguridad \\ del usuario \end{tabular}}                                               \\ \hline
        \end{tabular}%
    }
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
            ...
            \textbf{PH}                  & 1                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá registrarse en el sistema rellenando un formulario con campos \\ como el nombre de usuario, el correo electrónico, la contraseña... \end{tabular}}  \\ \hline
            \textbf{Prioridad}           & Baja                                        & \textbf{Dependencias} & \begin{tabular}[c]{@{}l@{}} --- \end{tabular}                      & \cellcolor[HTML]{D8D8D8}\begin{tabular}[c]{@{}l@{}}\textbf{Requisitos Funcionales}\end{tabular} & \begin{tabular}[c]{@{}l@{}}RF 1\end{tabular} \\ \hline
            \multicolumn{3}{|l|}{\cellcolor[HTML]{D8D8D8}\textbf{Pruebas de aceptacion}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}1. Todos los campos rellenados por el usuario serán almacenados en la base de datos \\ 2. La contraseña se almacenará cifrada para no comprometer la seguridad del usuario \end{tabular}}                                               \\ \hline
        \end{tabular}%
    }
\end{table}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
                ...
                >{\columncolor[HTML]{D8D8D8}}l |l|l|l|}
            \hline
            \textbf{ID}                  & HU26                                      & \textbf{Nombre}       & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}Como administrador quiero eliminar un usuario.\end{tabular}}\\ \hline
            \textbf{PH}                  & 0.5                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá registrarse en el sistema rellenando un formulario con campos \\ como el nombre de usuario, el correo electrónico, la contraseña... \end{tabular}}  \\ \hline
            \textbf{Prioridad}           & Media                                        & \textbf{Dependencias} & \begin{tabular}[c]{@{}l@{}} --- \end{tabular}                      & \cellcolor[HTML]{D8D8D8}\begin{tabular}[c]{@{}l@{}}\textbf{Requisitos Funcionales}\end{tabular} & \begin{tabular}[c]{@{}l@{}}RF 1\end{tabular} \\ \hline
            \multicolumn{3}{|l|}{\cellcolor[HTML]{D8D8D8}\textbf{Pruebas de aceptacion}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}1. Todos los campos rellenados por el usuario serán almacenados en la base de datos \\ 2. La contraseña se almacenará cifrada para no comprometer la seguridad del usuario \end{tabular}}                                               \\ \hline
        \end{tabular}%
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
                ...
                >{\columncolor[HTML]{D8D8D8}}l |l|l|l|}
            \hline
            \textbf{ID}                  & HU27                                      & \textbf{Nombre}       & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}Como administrador quiero eliminar un usuario.\end{tabular}}\\ \hline
            \textbf{PH}                  & 0.5                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá registrarse en el sistema rellenando un formulario con campos \\ como el nombre de usuario, el correo electrónico, la contraseña... \end{tabular}}  \\ \hline
            \textbf{Prioridad}           & Media                                        & \textbf{Dependencias} & \begin{tabular}[c]{@{}l@{}} --- \end{tabular}                      & \cellcolor[HTML]{D8D8D8}\begin{tabular}[c]{@{}l@{}}\textbf{Requisitos Funcionales}\end{tabular} & \begin{tabular}[c]{@{}l@{}}RF 1\end{tabular} \\ \hline
            \multicolumn{3}{|l|}{\cellcolor[HTML]{D8D8D8}\textbf{Pruebas de aceptacion}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}1. Todos los campos rellenados por el usuario serán almacenados en la base de datos \\ 2. La contraseña se almacenará cifrada para no comprometer la seguridad del usuario \end{tabular}}                                               \\ \hline
        \end{tabular}%
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
                ...
                >{\columncolor[HTML]{D8D8D8}}l |l|l|l|}
            \hline
            \textbf{ID}                  & HU28                                      & \textbf{Nombre}       & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}Como administrador quiero eliminar un usuario.\end{tabular}}\\ \hline
            \textbf{PH}                  & 0.5                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá registrarse en el sistema rellenando un formulario con campos \\ como el nombre de usuario, el correo electrónico, la contraseña... \end{tabular}}  \\ \hline
            \textbf{Prioridad}           & Media                                        & \textbf{Dependencias} & \begin{tabular}[c]{@{}l@{}} --- \end{tabular}                      & \cellcolor[HTML]{D8D8D8}\begin{tabular}[c]{@{}l@{}}\textbf{Requisitos Funcionales}\end{tabular} & \begin{tabular}[c]{@{}l@{}}RF 1\end{tabular} \\ \hline
            \multicolumn{3}{|l|}{\cellcolor[HTML]{D8D8D8}\textbf{Pruebas de aceptacion}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}1. Todos los campos rellenados por el usuario serán almacenados en la base de datos \\ 2. La contraseña se almacenará cifrada para no comprometer la seguridad del usuario \end{tabular}}                                               \\ \hline
        \end{tabular}%
