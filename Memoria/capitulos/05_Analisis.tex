...
%     \hline
%     \multicolumn{1}{|l|}{\textbf{ID:}}        & \multicolumn{1}{l|}{HU1}  & \textbf{Nombre:}       & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}EjemploEjemploEjemploEjemploEjemploEjemploEjemploEjemploEjemploEjemplo\\ EjemploEjemploEjemplo\end{tabular}}                                                                                                                                                        \\ \hline
%     \multicolumn{1}{|l|}{PH}        & \multicolumn{1}{l|}{1}    & Descripcion  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}EjemploEjemploEjemploEjemploEjemploEjemploEjemploEjemploEjemplo\\ EjemploEjemploEjemploEjemploEjemploEjemploEjemploEjemploEjemplo\\ EjemploEjemploEjemplo\end{tabular}}                                                                                                            \\ \hline
%     \multicolumn{1}{|l|}{\textbf{Prioridad}} & \multicolumn{1}{l|}{Alta} & \textbf{Dependencias} & \multicolumn{1}{l|}{HU24}                                                                              & \multicolumn{1}{l|}{\textbf{Requisitos Funcionales}}                                                                             & RF1                                                                           \\ \hline
%     \multicolumn{3}{|l|}{\textbf{Pruebas de aceptacion}}                                & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}ejemploejemploejemploejemploejemploejemploejemploejemploejemplo\\ ejemploejemplo\\ ejemploejemploejemploejemploejemploejemploejemploejemploejemplo\\ ejemploejemplo\\ejemploejemploejemploejemploejemploejemploejemploejemploejemplo\\ ejemploejemplo\\\end{tabular}} \\ \hline
%     \end{tabular}%
%     }
%     \end{table}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
            ...
            \textbf{PH}                  & 1                                     & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá visualizar todos los datos de su propio perfil, así \\como los logros obtenidos en su aprendizaje.\end{tabular}}  \\ \hline
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
            ...
            \textbf{PH}                  & 1                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá visitar los perfiles de otros usuarios registrados y ver sus logros \end{tabular}}  \\ \hline
            ...
            \multicolumn{3}{|l|}{\cellcolor[HTML]{D8D8D8}\textbf{Pruebas de aceptacion}} & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}1. Los datos mostrados al usuario en su perfil se corresponderán \\ con la información almacenada en la base de datos de dicho usuario. \\ 2. Los datos privados del usuario no se mostrarán, solo los que no sean personales. \\ 3. El usuario que no haya iniciado sesión no podrá ver ningún perfil.\end{tabular}}                                               \\ \hline
        \end{tabular}%
    }
\end{table}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
            ...
            \textbf{PH}                  & 1                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El usuario podrá visualizar la lista ordenada de usuarios con mayor progreso.\end{tabular}}  \\ \hline
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|
            ...
            \textbf{PH}                  & 0.5                                        & \textbf{Descripcion}  & \multicolumn{3}{l|}{\begin{tabular}[c]{@{}l@{}}El profesor podrá ver una lista de todos los alumnos registrados\\ en el sistema. \end{tabular}}  \\ \hline
