...
\begin{figure}[H]%
  \centering
  \subfloat[\centering Pantalla de dashboard con las opciones de gestión disponibles para el profesor.]{{\includegraphics[width=0.35\textwidth]{imagenes/c7/dashboard.png} }}%
  \qquad
