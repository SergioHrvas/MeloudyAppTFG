...
Tras enviar las respuestas del usuario mediante la petición del envío de test (POST /create-test-and-progress) al servidor, se comparan las respuestas del usuario con las respuestas correctas almacenadas en cada una de las preguntas (estas últimas se obtienen mediante el Provider de las preguntas). 
